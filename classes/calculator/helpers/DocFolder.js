...
var DocFolderHelper = function(Context){
	...
	self.Docs = function(done){
		self.query('doc',{}, "-_id CodeDoc CodeDocType PrintNameDoc PrintNumDoc NameDoc SNameDoc IsShowMeasure CodeMeasure IsBiztranDoc UseProd UseOrg UseDogovor UseDogovorArt IsTester IsChart IsPresent IsInput IsOlap IsDesigner IsDivObj IsObjToRow IsShowParentObj CodeGrp HasChildObjs Link_docobjtype Link_docrow IndexDoc CodeRole")
		.sort({IndexDoc:1})
