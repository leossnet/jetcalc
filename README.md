...
Платформа [JetCalc](https://www.leossnet.ru) предназначена для планирования и моделирования хозяйственной деятельности многопрофильных компаний с последующим сбором фактических данных и проведением экономического анализа. 
