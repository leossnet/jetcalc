module.exports = {
	models:{
		period:{
			  IsNone  : {type : Boolean  , default : false, extended:true, ignoresave:true},
			  BeginDateText            : {type : String, default : '31-01', trim : true, template:"form_text", mask:'99-99'},
			  EndDateText              : {type : String, default : '31-01', trim : true, template:"form_text", mask:'99-99'},
			  Formula                  : {template:"form_period_formula"}
		}
	},
	schema: {
